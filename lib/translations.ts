...
const translations = {
  ...
  home: {
    ...
    arc: {
      en: "USEA Career Center, in partnership with the USAID Digital Workforce Development, is established to connect HEIs and the local private sector for the creation of internship program and/or job opportunities for students and young professionals.", km: "មជ្ឈមណ្ឌលអាជីព USEA ដែលសហការជាមួយកម្មវិធីអភិវឌ្ឍន៍កម្លាំងពលកម្មឌីជីថលរបស់ USAID ត្រូវបានបង្កើតឡើងដើម្បីតភ្ជាប់គ្រឹះស្ថានឧត្តមសិក្សា និងវិស័យឯកជនក្នុងស្រុក ក្នុងគោលបំណងបង្កើតកម្មវិធីហាត់ការ និង/ឬឱកាសការងារសម្រាប់និស្សិត និងអ្នកជំនាញវ័យក្មេង។"
    }
  },
